...
DROP TABLE IF EXISTS ai_subscription;
DROP TABLE IF EXISTS ai_writing_profiles;
DROP TABLE IF EXISTS stripe_webhook_events;
DROP TABLE IF EXISTS managed_service_subscription;
...
DROP TABLE IF EXISTS contact_recents;
DROP TABLE IF EXISTS contact_emails;
DROP TABLE IF EXISTS contacts;
DROP TABLE IF EXISTS email_signature_defaults;
...
DROP TABLE IF EXISTS sovereign_mail_schema_state;
