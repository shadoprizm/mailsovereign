...
`https://github.com/shadoprizm/mailsovereign`. A release contains a source artifact and a signed
`stable.json` envelope using product identifier `sovereign-mail` and format
`sovereign-mail-release-v1`.
